...
public class ChangeHp(int change, bool isImmediate = false, bool isPercentage = true, bool isPierce = false) : IBuffEffect {
    ...
    private string[] Calc(Unit self, uint stacks) {
        ...
        return [string.Format(Lang.LogChangeHp, "", hpOld.Format(Colors.Hp), hpNew.Format(Colors.Hp), 
