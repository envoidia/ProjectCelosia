...
public static class Main
{
    ...
    private static void _Init()
    {
        ...
        Core.Battle = new API.Battle.Battle(new Team(
            new Unit(CBattle.UnitTypes.Johny, Lvl, null, CBattle.Skills.Fireball, CBattle.Skills.Fireball, CBattle.Skills.Fireball, CBattle.Skills.Fireball, CBattle.Skills.ChainLightning, Skills.Defend, Skills.Defend),
